...
<head>
    ...
    <title>SERVIS ROBOT | Galerija</title>
...
<body>
  ...
  <section class="fixmenu container">
   ...
   <section class="slider">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption text-center animated bounceInDown" style="animation-duration: 1.7s;">
                        ...
                        <h2>Nudimo brzu, kvalitetnu i povoljnu uslugu</h2>
                        <!-- <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Non, aspernatur.</p> -->
                        <a class="btn" href="/usluge.php">Usluge</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <!--Mask color-->
                    <div class="view">
                        <img class="d-block w-100 img-fluid" src="img/slide2.jpg" alt="Second slide">
                        <div class="mask rgba-black-strong"></div>
                    </div>
                    <div class="carousel-caption text-left animated bounceInRight" style="animation-duration: 1.7s;">
                    <div class="background-left">
                        <h2 class="h3-responsive">Uvek dostupni tu za Vas</h2>
                ...
                <div class="carousel-item">
                    <!--Mask color-->
                    <div class="view">
                        <img class="d-block w-100 img-fluid" src="img/slide4.jpg" alt="Third slide">
                        <div class="mask rgba-black-slight"></div>
                    </div>
                    <div class="carousel-caption text-center animated bounceInDown" style="animation-duration: 1.7s;">
                    <div class="background-center">
    ...
    <!-- main START -->
        <section class="galerija-slike">
          <div class="container">
            <div class="row">
                <div class="col-md-3 no-padd">
                    <a href="img/galerija1.jpg" data-toggle="lightbox"
                     data-gallery="img-gallery">
                      <div class="item">
                        <img src="img/galerija1.jpg" alt="Galerija slika 1" class="img-fluid">
                        <div class="item-overlay top"><i class="fas fa-expand-arrows-alt"></i></div>
                      </div>
                    </a>
                  </div>
                  <div class="col-md-3 no-padd">
                      <a href="img/galerija2.jpg" data-toggle="lightbox"
                       data-gallery="img-gallery">
                        <div class="item">
                          <img src="img/galerija2.jpg" alt="Galerija slika 1" class="img-fluid">
                          <div class="item-overlay top"><i class="fas fa-expand-arrows-alt"></i></div>
                        </div>
                      </a>
                    </div>
                    <div class="col-md-3 no-padd">
                        <a href="img/galerija3.jpg" data-toggle="lightbox"
                         data-gallery="img-gallery">
                          <div class="item">
                            <img src="img/galerija3.jpg" alt="Galerija slika 1" class="img-fluid">
                            <div class="item-overlay top"><i class="fas fa-expand-arrows-alt"></i></div>
                          </div>
                        </a>
                      </div>
                      <div class="col-md-3 no-padd">
                          <a href="img/galerija4.jpg" data-toggle="lightbox"
                           data-gallery="img-gallery">
                            <div class="item">
                              <img src="img/galerija4.jpg" alt="Galerija slika 1" class="img-fluid">
                              <div class="item-overlay top"><i class="fas fa-expand-arrows-alt"></i></div>
                            </div>
                          </a>
                        </div>
            ...
            <div class="row">
                <div class="col-md-3 no-padd">
                    <a href="img/galerija5.jpg" data-toggle="lightbox"
                     data-gallery="img-gallery">
                      <div class="item">
                        <img src="img/galerija5.jpg" alt="Galerija slika 1" class="img-fluid">
                        <div class="item-overlay top"><i class="fas fa-expand-arrows-alt"></i></div>
                      </div>
                    </a>
                  </div>
                  <div class="col-md-3 no-padd">
                      <a href="img/galerija6.jpg" data-toggle="lightbox"
                       data-gallery="img-gallery">
                        <div class="item">
                          <img src="img/galerija6.jpg" alt="Galerija slika 1" class="img-fluid">
                          <div class="item-overlay top"><i class="fas fa-expand-arrows-alt"></i></div>
                        </div>
                      </a>
                    </div>
                    <div class="col-md-3 no-padd">
                        <a href="img/galerija7.jpg" data-toggle="lightbox"
                         data-gallery="img-gallery">
                          <div class="item">
                            <img src="img/galerija7.jpg" alt="Galerija slika 1" class="img-fluid">
                            <div class="item-overlay top"><i class="fas fa-expand-arrows-alt"></i></div>
                          </div>
                        </a>
                      </div>
                      <div class="col-md-3 no-padd">
                          <a href="img/galerija8.jpg" data-toggle="lightbox"
                           data-gallery="img-gallery">
                            <div class="item">
                              <img src="img/galerija8.jpg" alt="Galerija slika 1" class="img-fluid">
                              <div class="item-overlay top"><i class="fas fa-expand-arrows-alt"></i></div>
                            </div>
                          </a>
                        </div>
            ...
            <div class="row">
                <div class="col-md-3 no-padd">
                    <a href="img/galerija9.jpg" data-toggle="lightbox"
                     data-gallery="img-gallery">
                      <div class="item">
                        <img src="img/galerija9.jpg" alt="Galerija slika 1" class="img-fluid">
                        <div class="item-overlay top"><i class="fas fa-expand-arrows-alt"></i></div>
                      </div>
                    </a>
                  </div>
                  <div class="col-md-3 no-padd">
                      <a href="img/galerija10.jpg" data-toggle="lightbox"
                       data-gallery="img-gallery">
                        <div class="item">
                          <img src="img/galerija10.jpg" alt="Galerija slika 1" class="img-fluid">
                          <div class="item-overlay top"><i class="fas fa-expand-arrows-alt"></i></div>
                        </div>
                      </a>
                    </div>
                    <div class="col-md-3 no-padd">
                        <a href="img/galerija11.jpg" data-toggle="lightbox"
                         data-gallery="img-gallery">
                          <div class="item">
                            <img src="img/galerija11.jpg" alt="Galerija slika 1" class="img-fluid">
                            <div class="item-overlay top"><i class="fas fa-expand-arrows-alt"></i></div>
                          </div>
                        </a>
                      </div>
                      <div class="col-md-3 no-padd">
                          <a href="img/galerija12.jpg" data-toggle="lightbox"
                           data-gallery="img-gallery">
                            <div class="item">
                              <img src="img/galerija12.jpg" alt="Galerija slika 1" class="img-fluid">
                              <div class="item-overlay top"><i class="fas fa-expand-arrows-alt"></i></div>
                            </div>
                          </a>
                        </div>
            ...
            <!-- <div class="row">
                <div class="col-md-3 no-padd">
                    <a href="img/galerija13.jpg" data-toggle="lightbox"
                     data-gallery="img-gallery">
                      <div class="item">
                        <img src="img/galerija13.jpg" alt="Galerija slika 1" class="img-fluid">
                        <div class="item-overlay top"><i class="fas fa-expand-arrows-alt"></i></div>
                      </div>
                    </a>
                  </div>
                  <div class="col-md-3 no-padd">
                      <a href="img/galerija14.jpg" data-toggle="lightbox"
                       data-gallery="img-gallery">
                        <div class="item">
                          <img src="img/galerija14.jpg" alt="Galerija slika 1" class="img-fluid">
                          <div class="item-overlay top"><i class="fas fa-expand-arrows-alt"></i></div>
                        </div>
                      </a>
                    </div>
                    <div class="col-md-3 no-padd">
                        <a href="img/galerija15.jpg" data-toggle="lightbox"
                         data-gallery="img-gallery">
                          <div class="item">
                            <img src="img/galerija15.jpg" alt="Galerija slika 1" class="img-fluid">
                            <div class="item-overlay top"><i class="fas fa-expand-arrows-alt"></i></div>
                          </div>
                        </a>
                      </div>
                      <div class="col-md-3 no-padd">
                          <a href="img/galerija16.jpg" data-toggle="lightbox"
                           data-gallery="img-gallery">
                            <div class="item">
                              <img src="img/galerija16.jpg" alt="Galerija slika 1" class="img-fluid">
                              <div class="item-overlay top"><i class="fas fa-expand-arrows-alt"></i></div>
                            </div>
                          </a>
                        </div>
